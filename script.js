...
var myWords = [
    ...
    ["das Gedicht", "", "القصيدة"],
    // 75
    ["die Assistentin", "", "المساعدة"],
    ["das Eisen", "", "الحديد"],
    ["die Geschwindigkeit", "", "السرعة"],
    ["die Gewohnheit", "", "العادة"],
    ["die Herkunft", "", "الأصل"],
    ["die Klingel", "", "الجرس"],
    ["die Klimaanlage", "", "مكيف الهواء"],
    ["die Laune", "", "المزاج"],
    ["das Leder", "", "الجلد"],
    ["der Lift", "", "المصعد"],
    ["das Magazin", "", "المجلة"],
    ["die Mehrheit", "", "الغالبية"],
    ["der Mieter", "", "المستأجر"],
    ["die Mieterin", "", "المستأجرة"],
    ["der Migrant", "", "المهاجر"],
    ["die Migrantin", "", "المهاجرة"],
    ...
    ["der Profi", "", "المحترف"],
    ["die Nadel", "", "الإبرة"],
    ["die Passagierin", "", "المسافرة"],
    ["das Plastik", "", "البلاستيك"],
    ["die Produktion", "", "الإنتاج"],
    ["der Professor", "", "الأستاذ"],
    ["die Professorin", "", "الأستاذة"],
    ["das Quartier", "", "الحي"],
    ["die Reportage", "", "التقرير"],
    ["der Reporter", "", "الصحفي"],
    ["die Reporterin", "", "الصحفية"],
    ["die Richterin", "", "القاضية"],
    ["der Service", "", "الخدمة"],
    ["der Spieler", "", "اللاعب"],
    ["die Spielerin", "", "اللاعبة"],
    ["die Tradition", "", "التقليد"],
    ["der Typ", "", "الرجل"],
    ["das Verbot", "", "المنع"],
    ["der Wetterbericht", "", "النشرة الجوية"],
    // 77
    ["die Trockenheit", "", "الجفاف"],
    ["der Schluck", "", "الشربة"],
    ["der Kunststoff", "", "البلاستيك"],
    ["die Geldbörse", "", "محفظة نقود"],
    ["der Schirm", "", "المظلة"],
    ["das Streichholz", "", "عود ثقاب"],
    ["der Stift", "", "القلم"],
    ["der Bahnsteig", "", "رصيف"],
    ["das Gleis", "", "السكة"],
    ["die Fläche", "", "المساحة"],
    ["der Fruchtsalat", "", "سلطة فواكه"],
    ["der Teig", "", "العجين"],
    ["der Lautsprecher", "", "مكبر الصوت"],
    ["das Haustier", "", "حيوان أليف"],
    ["das Abwaschbecken", "", "حوض الغسيل"],
    ["das Velo", "", "الدراجة"],
    ["der Kleiderständer", "", ""],
    ["der Schlauch", "", "الخرطوم"],
    ["die Haut", "", "الجلد"],
    ["die Haltestelle", "", "محطة الوقوف"],
    // 78
    ["die Bushaltestelle", "", "موقف الحافلات"],
    ["der Supermarkt", "", ""],
    ["das Popcorn", "", "الفشار"],
    ["das Wachs", "", "الشمع"],
    ["die Chilischote", "", "الفلفل الحار"],
    ["die Lizenz", "", "الترخيص"],
    ["der Autofahrer", "", "سائق سيارة"],
    ["der Radfahrer", "", "راكب دراجة"],
    ["der Fußgänger", "", "الراجل"],
    ["der Gurt", "", "الحزام"],
    ["der Schwamm", "", "اسفنجه"],
    ["das Bügeleisen", "", "مكواة الملابس"],
    ["das Bügelbrett", "", ""],
    ["der Kehrichtsack", "", "كيس القمامة"],
    ["der Müllsack", "", "كيس القمامة"],
    ["der Abfallsack", "", "كيس القمامة"],
    ["der Papierkorb", "", ""],
    ["der Müllwagen", "", "شاحنة القمامة"],
    ["das Abwasser", "", "ماء الصرف الصحي"],
    ["das Olivenöl", "", "زيت الزيتون"],
];
